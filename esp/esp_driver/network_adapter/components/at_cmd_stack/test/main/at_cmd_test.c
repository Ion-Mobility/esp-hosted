...
static const test_step_t test_suite_qmtclear_demo[] =
{
    {
        .at_cmd = "AT+QMTCONN=0,\"mqtt://broker.hivemq.com\",1883,\"esp32-wifi\"",
        .expected_resp = "OK\r\n\r\n+QMTCONN: 0,0,0"
    ...
    {
        .at_cmd = "AT+QMTCLEAR=0,0",
        .expected_resp = "+QMTCLEAR:\r\n0,0",
    },
    {
        .at_cmd = "AT+QMTPUBEX=0,2,0,\"8r88fh838f12hj1scqbb\",\"VV23RDFASDF\"",
        .expected_resp = "OK\r\n+QMTPUBEX: 0,0"
    },
    {
        .at_cmd = "AT+QMTCLEAR=0,0",
...
void TestCase_QmtClear()
{
    perform_at_cmd_test_suite(test_suite_qmtclear_demo,
        TOTAL_STEPS_OF_TEST_SUITE(test_suite_qmtclear_demo));
}
