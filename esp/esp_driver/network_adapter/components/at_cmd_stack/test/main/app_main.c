...
static const char *test_description_table[] =
{
    ...
    "Connect to WiFi",
    "Test parsing",
    "Test TCP-MQTT repeatedly connect/disconnect with public broker",
    "Test TCP-MQTT basic actions with public broker",
    "Test TCP-MQTT stress test with public broker",
    "Test TLS-MQTT repeatedly connect/disconnect with public broker",
    "Test TLS-MQTT basic actions with public broker",
    "Test TLS-MQTT stress test with public broker",
    "Test TLS-MQTT repeatedly connect/disconnect with ION broker",
    ...
    "Test AT command with AT+QMTCLEAR functionalities",
};
...
static void parse_and_exec_option(char *option)
{
    ...
    CHECK_MQTT_TEST_OPTION_AND_RUN("16", 2, TestCase_QmtClear);
