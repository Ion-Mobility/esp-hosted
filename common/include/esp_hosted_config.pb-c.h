...
#define CTRL_MSG__REQ__CONFIG_SMART_CONNECT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ctrl_msg__req__config_smart_connect__descriptor) \
    , 0, 0 }
...
#define CTRL_MSG__EVENT__STATION_CONNECT_FROM_ESPTOUCH__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ctrl_msg__event__station_connect_from_esptouch__descriptor) \
    , 0, {0,NULL} }


struct  CtrlMsgEventGotIP
{
  ProtobufCMessage base;
  ProtobufCBinaryData ipv4;
  ProtobufCBinaryData netmask;
  ProtobufCBinaryData gw;
};
#define CTRL_MSG__EVENT__GOT_IP__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ctrl_msg__event__got_ip__descriptor) \
    , {0,NULL}, {0,NULL}, {0,NULL} }


struct  CtrlMsgEventLostIP
{
  ProtobufCMessage base;
  int32_t resp;
};
#define CTRL_MSG__EVENT__LOST_IP__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ctrl_msg__event__lost_ip__descriptor) \
    , 0 }
...
typedef void (*CtrlMsgEventStationDisconnectFromESPSoftAP_Closure)
                 (const CtrlMsgEventStationDisconnectFromESPSoftAP *message,
                  void *closure_data);
typedef void (*CtrlMsgEventStationConnectFromESPTOUCH_Closure)
                 (const CtrlMsgEventStationConnectFromESPTOUCH *message,
                  void *closure_data);
typedef void (*CtrlMsgEventGotIP_Closure)
                 (const CtrlMsgEventGotIP *message,
                  void *closure_data);
